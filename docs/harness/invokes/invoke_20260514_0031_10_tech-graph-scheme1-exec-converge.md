...
> **路径勘误（2026-05-15）**：前端 `task_engineering_tech_graph_graph_json_export_v1.md` 已归档至 **`ai-ink-brain/content/tasks/done/`**；本文件元数据 `task_paths` 与 fenced 快照内原 `active/` 路径已替换为 `done/`，避免断链，所指仍为同一 task。
