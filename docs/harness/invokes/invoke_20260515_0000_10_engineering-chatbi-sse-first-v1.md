...
|------|-----|
| hat_id | 10 |
| template | 用户消息（需求帽 · 按审查 R1 可选回填 task） |
| task_paths | `ai-ink-brain-api-python/docs/tasks/active/task_engineering_chatbi_sse_first_v1.md` |
| related_review_or_none | `ai-ink-brain-api-python/docs/harness/reviews/task_engineering_chatbi_sse_first_v1_audit_R1_20260515.md` |
| created_utc_or_local | 2026-05-15（工作区落盘） |
| notes | 工作区 `docs/harness/invokes/`；主 task 在后端子仓 `docs/tasks/active/` |
...
不强制落盘；任务落盘到后端任务文件夹@ai-ink-brain-api-python/docs/tasks/active
~~~
