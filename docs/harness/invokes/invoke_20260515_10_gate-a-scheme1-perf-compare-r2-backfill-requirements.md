...
| task_paths | `ai-ink-brain-api-python/docs/tasks/active/task_engineering_tech_graph_gate_a_perf_compare_v1.md`（归档后路径以 `git mv` 结果为准） |
...
| notes | PR 合入后 task 收尾：§4.2 勾选、§10 PR/commit、头部状态；可选 `invoke_snapshot` 链 R2 审核 invoke |
