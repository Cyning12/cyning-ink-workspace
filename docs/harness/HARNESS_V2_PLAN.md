...
6. **`docs/harness/prompts/`** 与 **`docs/harness/reviews/`**：各帽独立 md + 任务审核落盘目录，版本化；与本规划 §3 同步修订。
...
`Harness`、`Verify`、`verification`、`verify-fast`、`test_strategy`、`freeze_id`、`failure_paths`、`gates_before_code`、`CI`、`帽子`、`prompts`、`reviews`、`任务审核`、`签收`、`SDD`、`TDD`、`自检结论`
