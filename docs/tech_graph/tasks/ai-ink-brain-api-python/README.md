# 后端（ai-ink-brain-api-python）专题草案区

图谱与导出产物真值：`docs/_tech_graph/`（与 `_contract_manifest.json` 同目录树内并行维护，见上级 `docs/tech_graph/SPEC/README.md`）。
...
| 子仓 task（**done**） | [`task_engineering_tech_graph_gate_c_v2_dual_track_v1.md`](../../../../ai-ink-brain-api-python/docs/tasks/done/task_engineering_tech_graph_gate_c_v2_dual_track_v1.md)（**闸口 C** · graph_v2 查询 vs 双轨原文 · 结论 [`conclusion_gate_c_v2_dual_track_v1_zh.md`](../../../../ai-ink-brain-api-python/docs/diary/jsonPKmermaid/reports/conclusion_gate_c_v2_dual_track_v1_zh.md)） |
